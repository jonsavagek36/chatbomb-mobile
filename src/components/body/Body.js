...
class Body extends Component {
  ...
  render() {
    ...
    if (this.props.view == 'Settings') {
      ...
      view = <Chat selectedFriend={this.props.selectedFriend} sendMessage={this.props.sendMessage} conversationView={this.props.conversationView} sendLive={this.props.sendLive} liveChat={this.props.liveChat} />;
    } else {
      view = null;
    }
    return (
